-- Migration: Update handle_new_user trigger to parse clinica_nome and plan choice
...
BEGIN
  ...
  ELSE
    ...
    ELSIF meta_plano = 'ilimitado_premium' THEN
      limite_msg := 999999;
      limite_proc := 999999;
    ELSE -- bronze ou outro
      limite_msg := 100;
      limite_proc := 10;
    END IF;

    -- Cria a clinica no trial com o nome especificado pelo usuário (ou o nome do usuário como fallback)
